...
// Since there is exactly one <rect> and one <text> per <g>,
// we can append these elements directly to the <g>,
// without needing additional data joins.
// Data joins are only needed when creating a variable number of children
// based on data; here we are appending just one child per parent.
// The appended <rect>s and <text>s inherit data from their parent g element, and thus we can use data to compute the bar width and label position.
